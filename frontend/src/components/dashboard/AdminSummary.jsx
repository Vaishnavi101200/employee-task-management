...
import { FaCheckCircle, FaFile, FaHourglass, FaHourglassHalf, FaMoneyBill, FaMoneyBillWave, FaTimesCircle, FaUsers } from "react-icons/fa";
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <SummaryCard icon={<FaUsers />} text={"Total Departments"} number={5} color={"bg-yellow-600"}/>
            ...
            <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <SummaryCard icon={<FaHourglassHalf />} text={"Leave Pending"} number="$654" color={"bg-yellow-600"}/>
